...
async def update_organization(
    ...
    return await handle_request(data_errors, manager.update_org)
...
async def get_organization(org_id: str = None):
    ...
    return await handle_request(data_errors, manager.get_org)
...
async def add_user_to_organization(
    ...
    return await handle_request(data_errors, manager.add_user_to_org)
...
async def remove_user_from_organization(
    ...
    return await handle_request(data_errors, manager.remove_user_from_org)


@router.get("/members/{org_id}")
async def get_organization_members(org_id: str):
    data_errors = (GetOrganization(org_id=org_id), [])
    return await handle_request(data_errors, manager.get_members)
